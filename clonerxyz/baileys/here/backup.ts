...
//const { BufferJSON, generateWAMessageFromContent, generateWAMessageContent, generateWAMessage, prepareWAMessageMedia, getContentType } = require('@adiwajshing/baileys')
...
store?.readFromFile('./baileys_store_multi1.json')
// save every 10s
setInterval(() => {
	store?.writeToFile('./baileys_store_multi1.json')
}, 10_000)
